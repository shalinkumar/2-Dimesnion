...
{
    public sealed class JerrySpriteTwo : Sprite
    {
        public static int RemoveLength;
        public float Scale = 0.9f;
        private float originalScale = 0.9f;

        public JerrySpriteTwo()
        {
        }

        public JerrySpriteTwo(Texture2D textureImage, Vector2 position, Point frameSize, int collisionOffSet,
